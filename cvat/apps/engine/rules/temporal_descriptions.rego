...
is_job_staff if { is_task_staff }
is_job_staff if { is_job_assignee }

is_description_admin if { is_task_staff }
is_description_admin if { is_description_owner }

is_description_staff if { is_job_staff }
is_description_staff if { is_description_admin }

default allow := false

allow if { utils.is_admin }
